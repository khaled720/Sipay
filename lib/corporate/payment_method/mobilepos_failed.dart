...
Widget Mobilepos_Failed() {
  return Mobilepos_Failed_panel();
}

class Mobilepos_Failed_panel extends StatefulWidget {
  Mobilepos_Failed_panel({Key key}) : super(key: key);
  @override
  _Mobilepos_Failed_panel createState() => _Mobilepos_Failed_panel();
}

class _Mobilepos_Failed_panel extends State<Mobilepos_Failed_panel> {
  @override
