                      ...
                      children: <Widget>[
                        ...
                        Container(
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(
                              'E-mail has been created successfully! \nYou can also copy or share the link to \ndirectly get paid.',
                              style: TextStyle(
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Expanded(
                              child: Text('DPL #9112 - One Time Link', style: TextStyle(color: Colors.black45, fontSize: 15)),
                            ),
                            Expanded(
                              child: Container(
                                  child: Align(
