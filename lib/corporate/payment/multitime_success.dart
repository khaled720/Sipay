...
Widget Multitime_Success() {
  return Multitime_Success_panel();
}

class Multitime_Success_panel extends StatefulWidget {
  Multitime_Success_panel({Key key}) : super(key: key);
  @override
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(
                              'DPL#9112 has been created successfully! \nYou can copy and share the link to \ndirectly get paid.',
                              style: TextStyle(
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Expanded(
                              child: Text('DPL #9112 - Multi Time Link', style: TextStyle(color: Colors.black45, fontSize: 15)),
                            ),
                            Expanded(
                              child: Container(
                                  child: Align(
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        Navigator.push(context, MaterialPageRoute(
                                          builder: (context) => Email_Multishare(),
                                        ));
                                      },
                                    ),
                                    Text(
                                  ...
                                  children: <Widget>[
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        Navigator.pop(context);
                                        Navigator.push(context, MaterialPageRoute(
                                          builder: (context) => Sms_Multishare(),
                                        ));
                                      },
                                    ),
                                    Text(
