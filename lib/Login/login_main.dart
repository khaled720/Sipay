...
import 'package:fluttersipay/Login/Login_register.dart';
...
import 'SMS_Userverification.dart';
import 'login_registration.dart';
import 'login_verification.dart';
import 'SMS_verification.dart';
import 'password_verify.dart';
import '../corporate/login/smsverification.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder> {
        ...
        '/corporate_merchant' : (BuildContext context) => C_Merchant_panel(),
...
class _MyLoginPageState extends State<MyLoginPage> {
  ...
  _NumberTextInputFormatter _phoneNumberFormatter = _NumberTextInputFormatter(90);
        ...
        Container(
          child: Padding(
            ...
            child: TextField(
              ...
              style: TextStyle(color: _checkemail ? Colors.black38 : Colors.red),
              controller: _emailController,
              decoration: InputDecoration(
                hintText: 'E-mail',
                hintStyle: CustomTextStyle.formField(context),
                enabledBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color: _checkemail ? Colors.black38 : Colors.red, width: 1.0)),
                focusedBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color: _checkemail ? Colors.black38 : Colors.red, width: 1.0)),
                prefixIcon: _checkemail ?  const Icon(
                  Icons.email,
                  color: Colors.black38,
                ):  const Icon(
                  Icons.cancel,
  ...
  _showDialog(bool customer) {
    if (!customer) {
        ...
        if (data.length != 0){
          ...
          showDialog(
              context: context,
              builder: (_) => new ErrorDialog( resetGame));
        }else{
